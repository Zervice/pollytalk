          ...
          <div className="prose dark:prose-invert max-w-none">
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc pl-6 mt-2">
                ...
                <li>
                  <p><strong>Website</strong> refers to PollyTalkie, accessible from <a href="https://www.pollytalkie.com/" rel="external nofollow noopener" target="_blank">https://www.pollytalkie.com/</a></p>
                </li>
                <li>
            ...
            <section className="mb-8">
              ...
              <ul className="list-none pl-6 mt-2">
                <li>By email: <a href="mailto:support@pollytalkie.com">support@pollytalkie.com</a></li>
                <li>By visiting this page on our website: <a href="https://www.pollytalkie.com/contact" target="_blank" rel="noopener noreferrer">https://pollytalkie.com/contact</a></li>
              </ul>
            </section>
          </div>
        </div>
