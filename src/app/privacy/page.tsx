          ...
          <div className="prose dark:prose-invert max-w-none">
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc pl-6 mt-2">
                ...
                <li>
                  <p><strong>Application</strong> refers to PollyTalkie, the software program provided by the Company.</p>
                </li>
                <li>
                  <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to PollyTalkie.</p>
                </li>
                <li>
                ...
                <li>
                  <p><strong>Website</strong> refers to PollyTalkie, accessible from <a href="https://pollytalk.zervice.me/" rel="external nofollow noopener" target="_blank">https://pollytalk.zervice.me/</a></p>
                </li>
                <li>
            ...
            <section className="mb-8">
              ...
              <ul className="list-none pl-6 mt-2">
                <li>By email: <a href="mailto:support@pollytalk.zervice.me">support@pollytalk.zervice.me</a></li>
                <li>By visiting this page on our website: <a href="https://pollytalk.zervice.me/contact" target="_blank" rel="noopener noreferrer">https://pollytalk.zervice.me/contact</a></li>
              </ul>
            </section>
          </div>
        </div>
